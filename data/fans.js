...
const FANS_DATA = [
 ...
 { id: "di_he", name: "地和", nameEn: "Earthly Hand", fan: 64,
  ...
  //  48 番  三倍満
  // ─────────────────────────────────────────────────────
  { id: "yi_se_si_tong_shun", name: "一色四同顺", nameEn: "Pure Quadruple Chow", fan: 48,
    desc: "同种花色四个完全相同的顺子。",
  ...
  { id: "yi_se_si_jie_gao", name: "一色四节高", nameEn: "Four Pure Shifted Pungs", fan: 48,
  ...
  { id: "liu_ju_man_guan", name: "流局满贯", nameEn: "Nagashi Mangan", nameAlt: ["幺九振切"], fan: 48,
  ...
  //  32 番  倍满
  // ─────────────────────────────────────────────────────
  { id: "yi_se_si_bu_gao", name: "一色四步高", nameEn: "Four Pure Shifted Chows", fan: 32,
  ...
  { id: "hun_yao_jiu", name: "混幺九", nameEn: "All Terminals and Honors", nameAlt: ["混老头"], fan: 32,
    desc: "胡牌中只有老头牌和字牌（即全为幺九牌），没有其他数字牌。",
    excludes: [],
    handTypes: ["33332", "七对"], meldAllowed: true,
  ...
  { id: "er_bei_kou", name: "二杯口", nameEn: "Twice Pure Double Chow", nameAlt: ["二盃口/两般高"], fan: 32,
  ...
  { id: "yi_se_san_tong_shun", name: "一色三同顺", nameEn: "Pure Triple Chow", fan: 24,
    desc: "同种花色三个完全相同的顺子。",
    excludes: ["一色三节高", "一般高"],
    handTypes: ["33332"], meldAllowed: true,
    tags: ["一色", "顺子"], source: "国标" ,
  ...
  { id: "yi_se_san_jie_gao", name: "一色三节高", nameEn: "Pure Shifted Pungs", fan: 24,
  ...
  { id: "yi_se_san_bu_gao", name: "一色三步高", nameEn: "Pure Shifted Chows", fan: 16,
  ...
  { id: "quan_dai_wu", name: "全带5", nameEn: "All Fives", fan: 16,
  ...
  { id: "miao_shou_hui_chun", name: "海底捞月", nameEn: "Last Draw", nameAlt: ["妙手回春（国标）"], fan: 8,
    desc: "自摸能摸到的最后一张牌。",
    excludes: [],
  ...
  { id: "bu_qiu_ren", name: "门清自摸", nameEn: "Fully Concealed Self-Draw", nameAlt: ["门清自摸和", "不求人"], fan: 2,
  ...
  //  0 番  流局与犯规
  // ─────────────────────────────────────────────────────
  { id: "jiu_pai", name: "九种九牌", nameEn: "Nine Terminals/Honors (Abortive Draw)", fan: 0,
    desc: "起手摸第一张牌时若之前无人鸣牌，且此时手牌有9种（不是9张）九牌（即幺牌，国士需要的牌），即可推倒手牌重开本局。不过庄，不算连庄，相当于重开。",
    excludes: [],
    handTypes: [], meldAllowed: false,
    tags: ["流局", "门清", "日麻"], source: "日麻",
    notes: "" },
    { id: "si_feng", name: "四风连打", nameEn: "Four Winds Abortive Draw", fan: 0,
    desc: "四人第一巡不鸣牌的情况下均打出同一张风牌，重开本局。不过庄，不算连庄，相当于重开。",
    excludes: [],
    handTypes: [], meldAllowed: false,
    tags: ["流局", "门清", "日麻"], source: "日麻",
    notes: "" },
    { id: "si_gang", name: "四杠散了", nameEn: "Four Kongs Abortive Draw", fan: 0,
    ...
    tags: ["流局", "日麻"], source: "日麻",
    notes: "" },
    { id: "zha_hu", name: "诈和", nameEn: "False Win (Chombo)", fan: 0,
    ...
    tags: [], source: "村规",
    notes: "" },
    { id: "zha_li_zhi", name: "诈立直", nameEn: "False Riichi", fan: 0,
    desc: "所有立直家在流局或者其他家和牌后都需要进行立直检查，未听者向其他三家交付各4000点",
    excludes: [],
    handTypes: [], meldAllowed: false,
    tags: [], source: "村规",
    notes: "" },
    { id: "chu_qian", name: "出千和其他不公正游戏行为", nameEn: "Cheating and Other Unfair Play", fan: 0,
